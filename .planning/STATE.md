...
- **Phase**: 7 — （Next to execute）
- **Status**: Phase 6 COMPLETE — 8/8 checks PASS
...
- 2026-05-09: Phase 6 执行完成 — QUA-03 重构（shell-escape + ffmpeg-args + task-ssh + task-state），task-manager.js 990→343 行，8/8 PASS
...
- Code Review CR-01：live-monitor.js getDouyinCookies 未调用 decrypt，待 Phase 7 前修复
